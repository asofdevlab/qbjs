		...
		<HomeLayout {...baseOptions()}>
			<div className="flex flex-col">
				...
				<section className="flex flex-col items-center justify-center text-center px-4 py-20 md:py-32">
					<h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">An ORM-Agnostic Query Builder</h1>
					<p className="text-lg md:text-xl text-fd-muted-foreground max-w-2xl mb-8">
						Building type-safe queries from API request query strings. Transform{" "}
